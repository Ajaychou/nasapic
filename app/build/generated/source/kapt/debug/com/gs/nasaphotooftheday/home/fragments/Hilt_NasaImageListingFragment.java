...
public abstract class Hilt_NasaImageListingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NasaImageListingFragment() {
    super();
  }

  Hilt_NasaImageListingFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NasaImageListingFragment_GeneratedInjector) this.generatedComponent()).injectNasaImageListingFragment(UnsafeCasts.<NasaImageListingFragment>unsafeCast(this));
    }
  }
