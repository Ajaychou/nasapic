...
public abstract class Hilt_NasaImageDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NasaImageDetailFragment() {
    super();
  }

  Hilt_NasaImageDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NasaImageDetailFragment_GeneratedInjector) this.generatedComponent()).injectNasaImageDetailFragment(UnsafeCasts.<NasaImageDetailFragment>unsafeCast(this));
    }
  }
